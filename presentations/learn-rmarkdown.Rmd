...
This will produce "As you can see in Table.<number of the figure>"
...
* There is a package called [reedoc](https://noamross.github.io/redoc/) in the works that allows you to knit to Word, get edits from authors, then pull updated document (with track changes) back into Word!
  * Very beta
...
xaringan is fully customizable (and looks pretty good out the gates)
